                            ...
                            uint32_t holdcycles, uint32_t pacecycles)
{
    ...
    if (readchannel != 0)
    {
        ...
        {
        case 0:
            RegOffset = BCM2835_SMI_READ0;
            break;
        case 1:
            RegOffset = BCM2835_SMI_READ1;
            break;
        case 2:
            RegOffset = BCM2835_SMI_READ2;
            break;
        case 3:
            RegOffset = BCM2835_SMI_READ3;
            break;
        default:
            return;
        }
    ...
    else
    {
        ...
        {
        case 0:
            RegOffset = BCM2835_SMI_WRITE0;
            break;
        case 1:
            RegOffset = BCM2835_SMI_WRITE1;
            break;
        case 2:
            RegOffset = BCM2835_SMI_WRITE2;
            break;
        case 3:
            RegOffset = BCM2835_SMI_WRITE3;
            break;
        default:
            return;
        }
